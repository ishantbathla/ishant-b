...
<form method="POST" action="profile" name="form1">
	<input type="hidden" name="method" 	value="UpdateOtherAccount"></input>
    <!-- Creating Table -->
    ...
    else
    {
    	...
    	Model model = (Model) session.getAttribute("otherUser");
    	...
    	proUpdated = model.getProfileUpdated();
    ...
    {
    	Model model = (Model) session.getAttribute("otherUser");
    	model = (Model) session.getAttribute("emptyFeild");
...
<p align="center"><a href="/profile?method=deleteOtherProfile">Delete this Profile</a></p>
    <!--Form Close -->
</form>
